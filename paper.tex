...
I also report sensitivity (correctly classified fires divided by total number of actual fires) and specificity (correctly identified non-fires divided by total number of non-fires), balanced accuracy and kappa. 
